...
public class CarvedTomatoBlock extends SimplePolymerBlock implements PolymerTexturedBlock {
    ...
    public CarvedTomatoBlock(Settings settings) {
        ...
        PolymerBlockModel model0 = PolymerBlockModel.of(Identifier.of(Tomato.MOD_ID, "block/carved_tomato_block"),0,0);
        PolymerBlockModel model1 = PolymerBlockModel.of(Identifier.of(Tomato.MOD_ID, "block/carved_tomato_block"),0,90);
        PolymerBlockModel model2 = PolymerBlockModel.of(Identifier.of(Tomato.MOD_ID, "block/carved_tomato_block"),0,180);
        PolymerBlockModel model3 = PolymerBlockModel.of(Identifier.of(Tomato.MOD_ID, "block/carved_tomato_block"),0,270);
